...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    GROUP_INVITE_LINK: 'https://chat.whatsapp.com/HuTGTZxKKrL48TiJZErqz6?mode=ems_copy_t',
    ADMIN_LIST_PATH: './admin.json',
    IMAGE_PATH: 'https://files.catbox.moe/5k7yl1.jpg',
    NEWSLETTER_JID: '120363419684008047@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    NEWS_JSON_URL: '',
    BOT_NAME: '|𝐓ʜᴀʀᴜ-𝐎ꜰꜰɪᴄɪᴀʟ|',
    OWNER_NAME: '𝘕𝘰𝘵𝘩𝘪𝘯𝘨....',
    OWNER_NUMBER: '94720349502',
    BOT_VERSION: '-ᴜɴʟɪᴍɪᴛᴇᴅ-ᴠᴇʀꜱɪᴏɴ-',
    BOT_FOOTER: '> © 𝐓ʜᴀʀᴜ-𝐎ꜰꜰɪᴄɪᴀʟ',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbBPQT2E50Ukvbb7EJ2k',
    BUTTON_IMAGES: {
        ALIVE: 'https://files.catbox.moe/5k7yl1.jpg',
        
        MENU: 'https://files.catbox.moe/vxbkk7.jpg',
        // Menu ek hduwa
        OWNER: 'https://files.catbox.moe/1mpidt.jpg',
        
        SONG: 'https://files.catbox.moe/62v2xv.jpg',
        
        VIDEO: 'https://files.catbox.moe/62v2xv.jpg'
    }
};
...
async function SendSlide(socket, jid, newsItems) {
    ...
    for (let item of newsItems) {
        ...
        try {
            ...
            imgBuffer = await Jimp.read('https://files.catbox.moe/62v2xv.jpg');
                ...
                buttons: [
                    {
                      ...
                      //ᴍᴇᴛʜᴀɴᴀ ᴍᴋ ʜᴜᴛᴛᴏ?
                      `{"display_text":"𝐃ᴇᴩʟᴏʏᴇ","url":"https:/","merchant_url":"https://www.google.com"}`
                    },
                    {
                        name: "cta_url",
                        buttonParamsJson: `{"display_text":"𝐂ᴏɴᴛᴀᴄᴛ","url":"https","merchant_url":"https://www.google.com"}`
                    }
                ]
            })
        });
        ...
        try {
            switch (command) {
                 case 'alive': {
                    ...
                    const title = '*@𝐓ʜᴀʀᴜ-𝐎ꜰꜰɪᴄɪᴀʟ!*';
                    const content = `> *𝐓ʜᴇ 𝐎ꜰꜰɪᴄɪᴀʟ 𝐖ʜᴀᴛꜱᴀᴩᴩ 𝐌ᴜʟᴛɪ 𝐃ᴇᴠᴀᴄᴇ 𝐀ɪ*\n` +                                   `*𝐁ᴏᴛ 𝐎ᴡɴᴇʀ :-𝘕𝘰𝘵𝘩𝘪𝘯𝘨...!*\n` +
                                   `*𝐎ᴡᴇɴʀ 𝐍ᴜᴍʙᴇʀ :- 94720349502.\n` +
                                   `*ᴍɪɴɪ ꜱɪᴛᴇ*\n` +
                                   `> 𝘊𝘰𝘮𝘪𝘯𝘨 𝘴𝘰𝘰𝘯..`;
                    ...
                    await socket.sendMessage(sender, {
                        ...
                        buttons: [
                            { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: '𝐌ᴇɴ𝐔!' }, type: 1 },
                            { buttonId: `${config.PREFIX}ping`, buttonText: { displayText: '𝐏ɪɴ𝐆!' }, type: 1 }
                        ],
                        quoted: msg
                    });
                    break;   
                ...
                case 'menu': {
                    ...
                    const title = '╭─────▏ `ʜᴇʟʟᴏᴡ`│─────\n│─ *🪄 Nᴀᴍᴇ:* `𝐓ʜᴀʀᴜ-𝐎ꜰᴄ ©𝐢𝐧𝐜` \│─ *🌐 ᴛʏᴩᴇ:* ᴍɪɴɪ ʙᴏᴛ\n▏─ *❗𝐎ᴡɴᴇʀ: 𝘕𝘰𝘵𝘩𝘪𝘯𝘨...\n╰─────';
                    const content = `*©ᴛʜᴀʀᴜ-ᴏꜰᴄ ɪɴᴄ*\n` +
                                   `*⥑╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾⥏*\n` +
                                   `>  ᴍᴜʟᴛɪ ᴅᴇᴠɪᴄᴇ ᴡᴀᴛꜱᴀᴘᴘ ʙᴏᴛ.\n` +
                                   `*❲🪄❳ ᴅᴇᴘʟᴏʏ*\n` +
                                   `> *ᴡᴇʙ* 𝘊𝘰𝘮𝘪𝘯𝘨 𝘴𝘰𝘰𝘯...`;
                    const footer = config.BOT_FOOTER;
                    ...
                    await socket.sendMessage(sender, {
                        ...
                        caption: formatMessage(title, content, footer),
                        buttons: [
                            { buttonId: `${config.PREFIX}amenu`, buttonText: { displayText: '𝐀ʟʟ-𝐌ᴇɴᴜ!' }, type: 1 },
                            { buttonId: `${config.PREFIX}ping`, buttonText: { displayText: '𝐏ɪɴ𝐆!' }, type: 1 },
                            { buttonId: `${config.PREFIX}system`, buttonText: { displayText: '𝐒ʏꜱᴛᴇʀ𝐌!' }, type: 1 },
...
│ ɢᴇᴛ ᴄʜᴀɴɴᴇʟ ɪɴꜰᴏ
╰───────────────────────╯
> *©-𝐏ᴏᴡᴇʀᴅ ʙʏ 𝗧ʜᴀʀυ-𝗢ꜰᴄ ᥊ ©-ιи𝘤*`;

                    const sentMsg = await socket.sendMessage(sender, {
                        image: { url: "https://files.catbox.moe/62v2xv.jpg"},
                        caption: kariyane,
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                newsletterJid: '120363419684008047@newsletter',
                                newsletterName: "𝐓ʜᴀʀᴜ-𝐎ꜰꜰɪᴄɪᴀʟ ©𝐢𝐧𝐜",
                                serverMessageId: 999
                            },
                            externalAdReply: {
                                title: 'ᴍᴜʟᴛɪ ᴅᴇᴠɪᴄᴇ  ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ',
                                body: '𝗧ʜᴀʀᴜ-𝗢ꜰᴄ!',
                                mediaType: 1,
                                sourceUrl: "𝘊𝘰𝘮𝘪𝘯𝘨 𝘴𝘰𝘰𝘯...",
                                thumbnailUrl: 'https://files.catbox.moe/62v2xv.jpg',
...
case 'song': {
    try {
        const q = args.join(" ");
        if (!q) {
            return reply("* 𝘐 𝘞𝘢𝘯𝘵 𝘵𝘰 𝘚𝘰𝘯𝘨 𝘕𝘢𝘮𝘦 𝘖𝘳 𝘠𝘰𝘶𝘵𝘶𝘣𝘦 𝘓𝘪𝘯𝘬*");
        }
        ...
        if (!apiRes?.status || !apiRes.result?.download) {
            return reply("❌ 𝘋𝘰𝘸𝘭𝘰𝘢𝘥𝘪𝘯𝘨 𝘌𝘳𝘳𝘰𝘳. 𝘛𝘳𝘺 𝘈𝘯𝘰𝘵𝘩𝘦𝘳 𝘚𝘰𝘯𝘨 𝘈𝘨𝘢𝘪𝘯");
        }
        ...
        const caption = `┏━━━━━━━━━━━━━━━━━━━━━┓        
  ┃ *ℹ️ 𝘛𝘪𝘵𝘭𝘦:* \`${data.title}\`
  ┃ *⏱️𝘋𝘶𝘳𝘢𝘵𝘪𝘰𝘯:* ${data.timestamp} 
  ┃ *🧬 𝘝𝘪𝘦𝘸𝘴:* ${data.views}
  ┃ 📅 *𝘙𝘦𝘭𝘦𝘴𝘦𝘥 𝘋𝘢𝘵𝘦:* ${data.ago}
  ┗━━━━━━━━━━━━━━━━━━━━━┛
 > -𝐏ᴏᴡᴇʀᴅ ʙʏ 𝗧ʜᴀʀυ-𝗢ꜰᴄ ᥊ ©-ιи𝘤*`;
...
break;
                ...
                case 'ping': {
                    ...
                    await socket.sendMessage(sender, { text: '《 █▒▒▒▒▒▒▒▒▒▒▒》𝟭𝟬%', edit: ping.key });
                    await socket.sendMessage(sender, { text: '《 ████▒▒▒▒▒▒▒▒》𝟯𝟬%', edit: ping.key });
                    await socket.sendMessage(sender, { text: '《 ███████▒▒▒▒▒》𝟱𝟬%', edit: ping.key });
                    await socket.sendMessage(sender, { text: '《 ██████████▒▒》𝟴𝟬%', edit: ping.key });
                    await socket.sendMessage(sender, { text: '《 ████████████》𝟭𝟬𝟬%', edit: ping.key });
                ...
                case 'owner': {
                    ...
                    const ownerContact = {
                        contacts: {
                            ...
                            contacts: [
                                {
                                    vcard: 'BEGIN:VCARD\nVERSION:3.0\nFN;CHARSET=UTF-8:𝘕𝘰𝘵𝘩𝘪𝘯𝘨-𝘟-\nTEL;TYPE=Coder,VOICE:+94720349502\nEND:VCARD',
                                },
                                {
                                    vcard: 'BEGIN:VCARD\nVERSION:3.0\nFN;CHARSET=UTF-8:ꜱ𝘖𝘸𝘯𝘦𝘳\nTEL;TYPE=Coder,VOICE:+94720349502\nEND:VCARD',
                                },
                            ],
                        },
                    };
...
case 'facebook': {
    try {
        ...
        if (!fbUrl) {
            return reply('* 𝘗𝘭𝘦𝘢𝘴𝘦 𝘗𝘳𝘰𝘷𝘪𝘥𝘦 𝘢 𝘍𝘢𝘤𝘦𝘣𝘰𝘰𝘬 𝘷𝘪𝘥𝘦𝘰 𝘰𝘳 𝘳𝘦𝘦𝘭 𝘜𝘙𝘓..!*');
        }
        ...
        await socket.sendMessage(sender, {
            video: { url: sd },
            caption: `*🪄𝐓ʜᴀʀᴜ-𝐎ꜰᴄ 𝐅ᴀᴄᴇʙᴏᴏᴋ 𝐕ɪᴅᴇᴏ 𝐃ᴏᴡʟᴏᴅᴇʀ❗*`,
        });
...
┃│ *𝘛𝘰𝘵𝘢𝘭*: ${totalStorage}
┃│ *𝘊𝘗𝘜 𝘕𝘦𝘦𝘥*: ${cpuSpeed} GHz
┃│*𝘕𝘶𝘮𝘣𝘦𝘳 𝘰𝘧 𝘊𝘗𝘜 𝘊𝘰𝘳𝘦𝘴*: ${cpuCount} 
┗━━━━━━━━━━━━━━━━━━━━━━━┛
 > *©-𝐏ᴏᴡᴇʀᴅ ʙʏ 𝗧ʜᴀʀυ-𝗢ꜰᴄ ᥊ ©-ιи𝘤*
`;
...
┏━━━━━━━━━━━━━━━━━━━┓
┃🔰 *𝘗𝘢𝘤𝘬𝘢𝘨𝘦:* ${packageName}
┃📄 *𝘋𝘦𝘴𝘤𝘳𝘪𝘱𝘵𝘪𝘰𝘯:* ${description}
┃⏸️ *𝘓𝘢𝘵𝘦𝘴𝘵 𝘝𝘦𝘳𝘴𝘪𝘰𝘯:* ${latestVersion}
┃🪪 *𝘓𝘪𝘤𝘦𝘯𝘤𝘦:* ${license}
┃🪩 *𝘙𝘦𝘱𝘰𝘴𝘪𝘵𝘰𝘳𝘺:* ${repository}
┃🔗 *𝘕𝘗𝘔 𝘜𝘙𝘓:* ${npmUrl}
┗━━━━━━━━━━━━━━━━━━━┛
> *©-𝐏ᴏᴡᴇʀᴅ ʙʏ 𝗧ʜᴀʀυ-𝗢ꜰᴄ ᥊*
`;
   ...
   case 'tiktoksearch': {
    ...
    try {
        ...
        for (const video of results) {
            const caption = `🌸 *𝐓ɪᴋ 𝐓ᴏᴋ 𝐕ɪᴅᴇᴏ 𝐒ᴇᴀʀᴄʜ!*\n\n` +
                           `📖 *𝘛𝘪𝘵𝘭𝘦:* ${video.title || 'Unknown'}\n` +
                           `👤 *𝘈𝘶𝘵𝘩𝘰𝘳:* ${video.author?.nickname || video.author || 'Unknown'}\n` +
                           `⏱ *𝘋𝘶𝘳𝘢𝘵𝘪𝘰𝘯:* ${video.duration || 'Unknown'}\n` +
                           `🔗 *𝘜𝘙𝘓:* ${video.link || 'N/A'}\n`;
...
case 'fc': {
    if (args.length === 0) {
        return await socket.sendMessage(sender, {
            text: '❗ Please provide a channel JID.\n\nExample:\n.fcn 120363419684008047@newsletter '
        });
    }
    ...
    try {
        ...
        if (metadata?.viewer_metadata === null) {
            ...
            await socket.sendMessage(sender, {
                text: `✅ 𝘚𝘶𝘤𝘤𝘦𝘴𝘴𝘧𝘶𝘭𝘭𝘶 𝘍𝘰𝘭𝘭𝘰𝘸𝘦𝘥 𝘛𝘩𝘦 𝘊𝘩𝘢𝘯𝘯𝘦𝘭:\n${jid}`
            });
 ...
 > *𝐏ᴏᴡᴇʀᴅ ʙʏ - 𝗧ʜᴀʀυ-𝗢ꜰᴄ ᥊❗*
    ...
    break;
                ...
                case 'pair': {
                    ...
                    if (!number) {
                        return await socket.sendMessage(sender, {
                            text: '*📌 Usage:* .pair +9476800XXXX'
                        }, { quoted: msg });
                    }

            // මේක හදපන්
                    try {
                        const url = `𝘊𝘰𝘮𝘪𝘯𝘨 𝘴𝘰𝘰𝘯...${encodeURIComponent(number)}`;
...
┏━━━━━━━━━━━━━━━━━━━━━┓
┃*01 🔗 𝘊𝘰𝘱𝘺 𝘛𝘩𝘪𝘴 𝘊𝘰𝘥𝘦*
┃*02 ❗𝘎𝘰 𝘠𝘰𝘶𝘳 𝘸𝘱 𝘓𝘪𝘯𝘬 𝘋𝘦𝘷𝘢𝘤𝘦*
┃*03 ✂️ 𝘗𝘢𝘴𝘵𝘦 𝘛𝘩𝘦 𝘊𝘰𝘥𝘦*
┃*04 🪄𝘞𝘢𝘪𝘵 𝘧𝘰𝘳 1 𝘔𝘶𝘯𝘪𝘵𝘦𝘴*
┃> After Your Bot Deploy 𝘚𝘶𝘤𝘤𝘦𝘴𝘴...
┗━━━━━━━━━━━━━━━━━━━━━┛
> *©-𝐏ᴏᴡᴇʀᴅ ʙʏ 𝗧ʜᴀʀυ-𝗢ꜰᴄ ᥊ ©-ιи𝘤!*
 ✅\n\n*
Your pairing code is:* ${result.code}`
    ...
    if (!channelLink) {
        return await socket.sendMessage(sender, {
            text: '❎ Please provide a WhatsApp Channel link.\n\n📌 *𝘌𝘹𝘢𝘮𝘱𝘭𝘦:* .cid https://whatsapp.com/channel/0029VbBPQT2E50Ukvbb7EJ2k/106'
        }, { quoted: msg });
    }
    ...
    try {
        ...
        const infoText = `
┏──────────────────┓
📡 *𝐖ʜᴀᴛꜱᴀᴩᴩ 𝐂ʜᴀɴɴᴇʟ 𝐈ɴꜰᴏ!*
┗──────────────────┛
┏━━━━━━━━━━━━━━━━━━━━━━┓
┃🆔 *𝘐𝘋:* ${metadata.id}
┃📌 *𝘕𝘢𝘮𝘦:* ${metadata.name}
┃👥 *𝘍𝘰𝘭𝘭𝘰𝘸𝘦𝘳𝘴:* ${metadata.subscribers?.toLocaleString() || 'N/A'}
┃📅 *𝘊𝘳𝘦𝘢𝘵𝘦 𝘖𝘯:* ${metadata.creation_time ? new Date(metadata.creation_time * 1000).toLocaleString("id-ID") : 'Unknown'}
┗━━━━━━━━━━━━━━━━━━━━━━━┛
 > *©-𝐏ᴏᴡᴇʀᴅ ʙʏ 𝗧ʜᴀʀυ-𝗢ꜰᴄ ᥊ ©-ιи𝘤!*`;
...
case 'react':
    try {
        ...
        if (!linkPart || !emoji) {
            await socket.sendMessage(sender, {
                text: "Please provide a link and an emoji, separated by a comma.\n\nUsage: .channelreact <channel_link>,<emoji>\n\𝚗𝘌𝘹𝘢𝘮𝘱𝘭𝘦: .𝘊𝘩𝘢𝘯𝘯𝘦𝘭𝘳𝘦𝘢𝘤𝘵 https://whatsapp.com/channel/0029VbBPQT2E50Ukvbb7EJ2k/106,❤️"
            });
            break;
        }
    ...
    try {
        ...
        const caption = `🎵 *𝐓ʜᴀʀᴜ-𝐎ꜰᴄ 𝐓ɪᴋᴛᴏᴋ 𝐃ᴏᴡʟᴏᴅᴇʀ!*\n\n` +
                        `👤 *𝘜𝘴𝘦𝘳:* ${author.nickname} (@${author.username})\n` +
                        `📖 *𝘛𝘪𝘵𝘭𝘦:* ${title}\n` +
                        `👍 *𝘓𝘪𝘬𝘦𝘴:* ${like}\n💬 *𝘊𝘰𝘮𝘮𝘦𝘯𝘵𝘴:* ${comment}\n🔁 *𝘚𝘩𝘢𝘳𝘦𝘴:* ${share}`;
